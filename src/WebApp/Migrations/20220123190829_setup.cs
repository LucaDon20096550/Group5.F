    ...
    public partial class setup : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    GuidedById = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    GuidesId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApplicationUserAppointment", x => new { x.AppointmentsId, x.UsersId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OverviewFiles", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                name: "ApplicationUserPrivateChat",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApplicationUserPrivateChat", x => new { x.PrivateChatsId, x.UsersId });
                    table.ForeignKey(
                        name: "FK_ApplicationUserPrivateChat_AspNetUsers_UsersId",
                        column: x => x.UsersId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApplicationUserAppointment_UsersId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApplicationUserPrivateChat_UsersId",
